...
class FileServices(base_api.BaseApi):
    ...
    def get_bandwidth_control_protocol_settings(self, protocol: str, schedule_plan: str) -> dict:
        """Get bandwidth control protocol settings
            ...
            ----------
            protocol : str
                Protocol name, here are the known protocols:
                - "FTP"
                - "NetworkBackup"
    ...
    def set_ftp_settings(self, enable_ftp: bool, enable_ftps: bool,
        ...
        """Set FTP settings
            ...
            portnum : int
                Port number. Default to `21`.
            
            custom_port_range : bool
                Enable or disable custom port range. Default to `False`.
            
            use_ext_ip : bool
                Enable or disable external IP. Default to `False`.
            
            enable_fxp : bool
                Enable or disable FXP. Default to `True`.
            
            enable_ascii : bool
                Enable or disable ASCII mode. Default to `True`.
            
            utf8_mode : int
                UTF-8 mode (0: disable, 1: Auto, 2: Force). Default to `1`.
            
            modify_time_std : str
                Modify time standard ("utc", "local"). Default to `"utc"`.
            
            custom_port : str
                Custom port range. Default to `"55536:55899"`.
            
            external_ip : str
                External IP address. Default to `"default"`.
