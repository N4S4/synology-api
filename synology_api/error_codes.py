...
# NOTE: https://global.synologydownload.com/download/Document/Software/DeveloperGuide/Package/Calendar/2.4/enu/Synology_Calendar_API_Guide_enu.pdf,
#    Refers to common error code # 160, "Insufficient application privilige" Page 10.
...
# Source: https://global.synologydownload.com/download/Document/Software/DeveloperGuide/Os/DSM/All/enu/DSM_Login_Web_API_Guide_enu.pdf
# Page 16.
...
# Pages 32,33 Refers to Auth error code #411: 'Account Locked (when account max try exceed).'
...
# Source: https://global.synologydownload.com/download/Document/Software/DeveloperGuide/Package/Virtualization/All/enu/Synology_Virtual_Machine_Manager_API_Guide.pdf
# Page 8,9
virtualization_error_codes : dict[int, str] = {
    401: 'Bad parameter.',
    402: 'Operation failed.',
    403: 'Name conflict.',
    404: 'The number of iSCSI LUNs has reached the system limit. Note: vdisk is based on iSCSI LUN, which is also limited by the system.',
...
# Source: https://global.synologydownload.com/download/Document/Software/DeveloperGuide/Package/Calendar/2.4/enu/Synology_Calendar_API_Guide_enu.pdf
# Pages 10,11.
...
# # Source: https://global.download.synology.com/download/Document/Software/DeveloperGuide/Package/SurveillanceStation/All/enu/Surveillance_Station_Web_API.pdf
# NOTE: Pages 81, 131,132, 155, 190, 222, 305, 314, 321, 328, 451, 473 539, 556, contain unique items.
# Most of these are duplicate information, but they describe different methods, all the error codes I found are on
# # Pages: 71, 81, 85, 93, 103, 113, 131, 132, 139, 144, 155, 167, 169, 176, 187, 190, 191, 201, 211, 212, 217, 222, 227,
# #         241, 245, 249, 253, 264, 279, 281, 305, 314, 321, 328, 363, 365, 368, 369, 393, 395, 397, 403, 410, 412, 415,
# #         419, 430, 451, 473, 539, 556
surveillance_station_error_codes : dict[int, str] = {
    ...
    567: 'The face database is under syncrhonization.',
}
