...
class DownloadStation:
    ...
    def __init__(self,
        ...
        self.download_list : dict[str, object] = self.session.app_api_list
    ...
    def schedule_set_config(self, enabled:bool=False, emule_enabled:bool=False) -> dict[str, object]:
        api_name = 'SYNO.DownloadStation.Schedule'
        info = self.download_list[api_name]
        api_path = info['path']
    ...
    def tasks_list(self, additional_param:Optional[str|list[str]]=None, offset:int=0, limit:int=-1) -> dict[str, object]:
    ...
    def tasks_info(self, task_id:str|list[str], additional_param:Optional[str|list[str]]=None) -> dict[str, object]:
        api_name = 'SYNO.DownloadStation.Task'
        info = self.download_list[api_name]
        api_path = info['path']
    ...
    def create_task(self, uri:str, additional_param:Optional[dict[str, str]]=None) -> dict[str, object]:
        api_name = 'SYNO.DownloadStation.Task'
        info = self.download_list[api_name]
        api_path = info['path']
    ...
    def delete_task(self, task_id:str|list[str], force:bool=False) -> dict[str, object]:
        api_name = 'SYNO.DownloadStation.Task'
        info = self.download_list[api_name]
        api_path = info['path']
    ...
    def pause_task(self, task_id:str|list[str]) -> dict[str, object]:
        api_name = 'SYNO.DownloadStation.Task'
        info = self.download_list[api_name]
        api_path = info['path']
    ...
    def resume_task(self, task_id:str|list[str]) -> dict[str, object]:
        api_name = 'SYNO.DownloadStation.Task'
        info = self.download_list[api_name]
        api_path = info['path']
    ...
    def edit_task(self, task_id:str|list[str], destination:str='sharedfolder') -> dict[str, object]:
        api_name = 'SYNO.DownloadStation.Task'
        info = self.download_list[api_name]
        api_path = info['path']
    ...
    def get_statistic_info(self) -> dict[str, object]:
    ...
    def get_rss_info_list(self, offset:Optional[int]=None, limit:Optional[int]=None) -> dict[str, object]:
    ...
    def refresh_rss_site(self, rss_id:str) -> dict[str, object]:
        api_name = 'SYNO.DownloadStation.RSS.Site'
        info = self.download_list[api_name]
        api_path = info['path']
    ...
    def rss_feed_list(self, rss_id:str, offset:Optional[int]=None, limit:Optional[int]=None) -> dict[str, object]:
    ...
    def start_bt_search(self, keyword:str, module='all') -> dict[str, object]:
    ...
    def get_bt_search_category(self) -> dict[str, object]:
        api_name = 'SYNO.DownloadStation.BTSearch'
        info = self.download_list[api_name]
        api_path = info['path']
    ...
    def clean_bt_search(self, taskid:str|list[str]) -> dict[str, object]:
        api_name = 'SYNO.DownloadStation.BTSearch'
        info = self.download_list[api_name]
        api_path = info['path']
    ...
    def get_bt_module(self) -> dict[str, object]:
        api_name = 'SYNO.DownloadStation.BTSearch'
        info = self.download_list[api_name]
        api_path = info['path']
