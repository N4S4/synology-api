...
class FileStation:
    ...
    def get_file_info(self, path:Optional[str|list[str]]=None, additional:Optional[str|list[str]]=None) -> dict[str, object]:
        api_name = 'SYNO.FileStation.List'
        info = self.file_station_list[api_name]
        api_path = info['path']
    ...
    def stop_search_task(self, taskid:str) -> dict[str, object]:
        api_name = 'SYNO.FileStation.Search'
        info = self.file_station_list[api_name]
        api_path = info['path']
    ...
    def replace_all_favorite(self, path:str, name:str) -> dict[str, object]:
        api_name = 'SYNO.FileStation.Favorite'
        info = self.file_station_list[api_name]
        api_path = info['path']
        req_param = {'version': info['maxVersion'], 'method': 'edit'}
    ...
    def start_dir_size_calc(self, path:str) -> tuple[str] | dict[str, object]:
    ...
    def get_dir_status(self, taskid:Optional[str]=None) -> dict[str, object]:
        api_name = 'SYNO.FileStation.DirSize'
        info = self.file_station_list[api_name]
        api_path = info['path']
    ...
    def create_sharing_link(self,
                                ...
                                date_expired : Optional[str | int] = None, # Can be 0 for default: permanent link
                                date_available : Optional[str | int] = None, # Can be 0 for default: Available immediatly.
                                expire_times : int = 0
                            ) -> dict[str, object]:
        api_name = 'SYNO.FileStation.Sharing'
        info = self.file_station_list[api_name]
    ...
    def delete_shared_link(self, link_id:str) -> dict[str, object]:
        api_name = 'SYNO.FileStation.Sharing'
        info = self.file_station_list[api_name]
        api_path = info['path']
        req_param = {'version': info['maxVersion'], 'method': 'delete'}
