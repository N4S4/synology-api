...
class SecurityAdvisor(base_api_core.Core):
    ...
    def security_scan(self) -> dict[str, object]:
    ...
    def checklist(self) -> dict[str, object]:
    ...
    def login_activity(self, offset:int=0, limit:int=20) -> dict[str, object]:
    ...
    def advisor_config(self) -> dict[str, object]:
    ...
    def scan_config(self) -> dict[str, object]:
        api_name = 'SYNO.Core.SecurityScan.Conf'
        info = self.gen_list[api_name]
        api_path = info['path']
