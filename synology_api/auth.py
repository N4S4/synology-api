...
class Authentication:
    def __init__(self,
        ...
        self.full_api_list : dict[str, object] = {}
        self.app_api_list : dict[str, object] = {}
        return
    ...
    def request_data(self,
                    ...
                    ) -> dict[str, object] | requests.models.Response:  # 'post' or 'get'
    ...
    @staticmethod
    def _get_error_code(response: dict) -> int:
