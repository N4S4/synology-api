...
sidebar_position: 49
title: 🚧 SysInfo
description: "Core System Information API implementation for Synology NAS." 
---
...
This page contains documentation for the `SysInfo` class and its subclasses:  
