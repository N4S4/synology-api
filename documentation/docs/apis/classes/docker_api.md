...
**_enable_service_portal_** `bool`  
Enable the DSM reverse-proxy portal. Defaults to False.  
  
**_service_portal_name_** `str`  
Portal display name.  
  
**_service_portal_port_** `int`  
Portal target port.  
  
**_service_portal_protocol_** `str`  
